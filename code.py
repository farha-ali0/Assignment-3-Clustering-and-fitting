...
def balance_data(df):
  ...
  min_length = min(len(co2_emissions), len(cereal_yield), len(population_growth))
...
scaler = MinMaxScaler()
scaled_data = scaler.fit_transform(df[['co2_emissions', 'population_growth',
       'cereal_yield']])
...
plot_clusters('population_growth', 'co2_emissions')

plot_clusters('population_growth', 'cereal_yield')
...
plot_country_cluster('China', 'population_growth', 'co2_emissions')

plot_country_cluster('Kenya', 'population_growth', 'cereal_yield')
